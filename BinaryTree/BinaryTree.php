...
INTRO;
    ...
    echo "<h2>Input vector: ", join($arr," "), "</h2><br>";

    echo"<h1>Breadh-First Traversal Tree</h1><br>"; 
    echo $tree->BFT();

    echo"<h1>Inorder</h1><br>"; 
    $tree->traverse('inorder') . "<br>";


    echo"<h1>Postorder</h1><br>"; 
    $tree->traverse('postorder') . "<br>";

    echo"<h1>Preorder</h1><br>"; 
    $tree->traverse('preorder') . "<br>";
